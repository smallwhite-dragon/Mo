...
def getRes(image_file=None, detector=None):
    ...
    if FLAGS.image_file is not None and '' != FLAGS.image_file and detector is not None:
...
def buildDetector(model_dir=None, image_file=None, video_file=''
         ...
         , threshold=0.5, output_dir='output1', visual=False):
    global FLAGS
    res = None
    ...
    # predict from image
    # if FLAGS.image_file is not None and '' != FLAGS.image_file:
    #     return predict_image(detector)
...
if __name__ == '__main__':
    a_det = buildDetector(model_dir='model/hxm-4820')
    for i in range(1,20):
        getRes(image_file='cp1517162058NG.jpg', detector=a_det)
